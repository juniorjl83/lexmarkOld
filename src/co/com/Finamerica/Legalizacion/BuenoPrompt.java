...
public class BuenoPrompt implements VlmlPrompt
{
   ...
   public String getVlml()
   {
      ...
      screen.append("  <AttachChild left=\"0\" right=\"9\" top=\"1\" bottom=\"2\"  xGFill=\"expandFill\" yGFill=\"expandFill\">\n");
    		  screen.append("  <Label name=\"label\" pointSize=\"22\" text=\" ¿ Cuál es la razón para estar muy satisfecho? \" lineWrap=\"false\" justification=\"center\" style=\"normal\" color=\"00ff02\"/>\n");
            ...
            screen.append("  <AttachChild left=\"0\" right=\"9\" top=\"4\" bottom=\"9\" xFill=\"shrink\" xPadding=\"100\" yFill=\"expand\" yPadding=\"0\">\n");
    		  ...
    		  screen.append("  <Label text=\"Es fácil de usar\" location=\"left\"/>\n");
    		  screen.append("  </Selection>\n");
    		  screen.append("  <Selection name=\"orange\">\n");
    		  screen.append("  <DeselectedImage imageName=\"commonListButtonUp\"/>\n");
    		  screen.append("  <SelectedImage imageName=\"commonListButtonDown\"/>\n");
    		  screen.append("  <Label text=\"Siempre está disponible\" location=\"left\"/>\n");
    		  screen.append("  </Selection>\n");
    		  screen.append("  <Selection name=\"yellow\">\n");
    		  screen.append("  <DeselectedImage imageName=\"commonListButtonUp\"/>\n");
    		  screen.append("  <SelectedImage imageName=\"commonListButtonDown\"/>\n");
    		  screen.append("  <Label text=\"Cumple con las necesidades\" location=\"left\"/>\n");
    		  screen.append("  </Selection>\n");
   ...
   public String getId()
   {
      ...
      return "example.customvlmlprompt.BuenoPrompt";
   }
