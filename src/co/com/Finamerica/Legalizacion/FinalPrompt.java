...
public class FinalPrompt implements VlmlPrompt
{
   ...
   public String getVlml()
   {
      ...
      screen.append("  <GridLayout name=\"main\" distribution=\"homogeneous\" columns=\"20\" rows=\"10\" spacing=\"0\" verticalScroll=\"never\" horizontalScroll=\"never\">\n");
      
      
      screen.append("  <AttachChild left=\"1\" right=\"18\" top=\"4\" bottom=\"5\" xGFill=\"expandFill\" yGFill=\"expandFill\">\n");
	  screen.append("  <Label name=\"label\" pointSize=\"22\" text=\"Esta encuesta la podrás diligenciar el número de veces\" lineWrap=\"false\" justification=\"center\" style=\"normal\" color=\"0000BB\"/>\n");
	  screen.append("  </AttachChild>\n");
	  
      screen.append("  <AttachChild left=\"1\" right=\"10\" top=\"5\" bottom=\"6\" xGFill=\"expandFill\" yGFill=\"expandFill\">\n");
	  screen.append("  <Label name=\"label1\" pointSize=\"22\" text=\"que consideres necesario\" lineWrap=\"true\" justification=\"left\" style=\"normal\" color=\"0000BB\"/>\n");
	  screen.append("  </AttachChild>\n");
	  
	  

	  
	  screen.append("  <AttachChild left=\"1\" right=\"18\" top=\"10\" bottom=\"11\" xGFill=\"expandFill\" yGFill=\"expandFill\">\n");
	  screen.append("  <Label name=\"label20\" pointSize=\"22\" text=\"¡Muchas gracias por ayudarnos a mejorar nuestro servicio!\" lineWrap=\"false\" justification=\"center\" style=\"normal\" color=\"0000BB\"/>\n");
	  screen.append("  </AttachChild>\n");
      ...
      screen.append("  <Normal imageName=\"navRowOptionsUp\" text=\"terminar\"/>\n");
      screen.append("  <Selected imageName=\"navRowOptionsDown\" text=\"terminar\"/>\n");
         ...
         Element data) throws PromptException
   {
    ...
    //  result = PromptEventResult.RETURN;
     // return result;
      ...
      if(component.indexOf("hardwareKey") >= 0)
      {
         String componentName = vlmlName + ".hardwareKeyInfo";
         context.setText(componentName, "You pressed: " + component);
         
         // If they pressed "0", then exit the prompt.
         if(component.endsWith("0"))
         {
            dismissButton = "savedByZero";
      ...
      else if(component.endsWith("quitButton"))
      {
   ...
   public String getId()
   {
      ...
      return "example.customvlmlprompt.FinalPrompt";
   }
